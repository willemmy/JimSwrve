...
public class RobotContainer {
  ...
  private final SwerveDriveSub m_swerveDriveSub = new SwerveDriveSub (backRight, backLeft, frontRight, frontLeft);

  private final ExampleCommand m_autoCommand = new ExampleCommand(m_swerveDriveSub);
